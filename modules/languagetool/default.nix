...
let
  cfg = config.languagetool;
  unstable = pkgs.unstable;
in
{
  options = {
    languagetool.enable = lib.mkEnableOption "Enable languagetool.";
    languagetool.user = lib.mkOption {
      type = lib.types.str;
      default = "gquetel";
      description = "Username to install languagetools for";
    };
  };
